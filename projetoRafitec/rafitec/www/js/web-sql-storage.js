var WebSqlDB = function(successCallback, errorCallback) {
    ...
    this.initializeDatabase = function(successCallback, errorCallback) {
        ...
        this.db = window.openDatabase("tccfreakdb", "1.0", "TCCFreak Database", 4 * 1014 * 1024);   
    ...
    this.addSampleData = function(tx) {
        // Array of objects
        var trabalhos = [
                {"codtra": 1, "nomtra": "TCC 01", "nomcur": "Ciência da Computação"},
                {"codtra": 2, "nomtra": "TCC 02", "nomcur": "Ciência da Computação"},
                {"codtra": 3, "nomtra": "TCC 03", "nomcur": "Administração"},
                {"codtra": 4, "nomtra": "TCC 04", "nomcur": "Ciências Contábeis"}
            ];
        
        // Array of objects
        var alunos = [
                {"codalu": 1, "nomalu": "Aluno 1", "nomcur": "Ciência da Computação", fotalu: "aluno1.png"},
                {"codalu": 2, "nomalu": "Aluno 2", "nomcur": "Ciência da Computação", fotalu: "aluno2.png"},
                {"codalu": 3, "nomalu": "Aluno 3", "nomcur": "Administração", fotalu: "aluno3.png"},
                {"codalu": 4, "nomalu": "Aluno 4", "nomcur": "Administração", fotalu: "aluno4.png"},
                {"codalu": 5, "nomalu": "Aluno 5", "nomcur": "Ciências Contábeis", fotalu: "aluno5.png"},
                {"codalu": 6, "nomalu": "Aluno 6", "nomcur": "Ciências Contábeis", fotalu: "aluno6.png"}
            ];
        ...
        this.db.transaction(
            function(tx) {
                ...
                tx.executeSql(sql, null, function(tx, results) {
                    var len = results.rows.length, trabalhos = [], i = 0;
                     for (; i < len; i++) {
